function depth_label = relative_labeling_v4(depth_map)

load('depth_ratio_064_064_quant.mat', 'depth_ratio_064_064_quant')
...
for index_chapter = 1 : 40
    depth_label(:,:,:,index_chapter) = (relative_depth_map >= depth_ratio_064_064_quant(index_chapter));
end

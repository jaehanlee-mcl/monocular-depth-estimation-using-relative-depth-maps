function depth_label = relative_labeling_v2(depth_map)

load('depth_ratio_016_016_quant.mat', 'depth_ratio_016_016_quant')
depth_map_resized = exp(imresize(log(depth_map), [008,008], 'box'));
...
for index_chapter = 1 : 40
    depth_label(:,:,:,index_chapter) = (relative_depth_map >= depth_ratio_016_016_quant(index_chapter));
end

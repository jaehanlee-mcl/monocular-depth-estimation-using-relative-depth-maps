function depth_label = relative_labeling_v5(depth_map)

load('depth_ratio_128_128_quant.mat', 'depth_ratio_128_128_quant')
depth_map_resized = exp(imresize(log(depth_map), [064,064], 'box'));
...
for index_chapter = 1 : 40
    depth_label(:,:,:,index_chapter) = (relative_depth_map >= depth_ratio_128_128_quant(index_chapter));
end

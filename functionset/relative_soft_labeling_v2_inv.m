function relative_depth_map = relative_soft_labeling_v2_inv(depth_label)

load('depth_ratio_016_016_quant.mat', 'depth_ratio_016_016_quant_inv')
log_depth_ratio_016_016_quant_inv = log(depth_ratio_016_016_quant_inv);
...
log_relative_depth_map ...
    = log_depth_ratio_016_016_quant_inv(depth_label_high) .* depth_label_low_gap ...
    + log_depth_ratio_016_016_quant_inv(depth_label_low) .* depth_label_high_gap;
